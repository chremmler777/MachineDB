...
test('qualifies: tonnage in range, no flags required, all OK', () => {
  const machine = { id: 1, clamping_force_kn: 350, iu1_shot_volume_cm3: 800, is_2k: false, has_mucell: false, has_variotherm: true };
...
test('qualifies: tonnage below min → fails with reason', () => {
  const machine = { id: 1, clamping_force_kn: 200, iu1_shot_volume_cm3: 800, is_2k: false, has_mucell: false, has_variotherm: false };
...
test('qualifies: shot volume insufficient → fails', () => {
  const machine = { id: 1, clamping_force_kn: 350, iu1_shot_volume_cm3: 500, is_2k: false, has_mucell: false, has_variotherm: false };
...
test('qualifies: requires_2k but machine lacks → fails', () => {
  const machine = { id: 1, clamping_force_kn: 1300, iu1_shot_volume_cm3: 5000, is_2k: false, has_mucell: false, has_variotherm: false };
...
const machinesFixture: MachineRow[] = [
  { id: 1, clamping_force_kn: 350, iu1_shot_volume_cm3: 1000, is_2k: false, has_mucell: false, has_variotherm: true },
  { id: 2, clamping_force_kn: 350, iu1_shot_volume_cm3: 1000, is_2k: false, has_mucell: false, has_variotherm: true },
];
